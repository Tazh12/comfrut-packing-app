...
-- CREATE POLICY "Allow authenticated users to delete checklist_staff_glasses_auditory"
--     ON public.checklist_staff_glasses_auditory
--     FOR DELETE
--     TO authenticated
--     USING (true);
...
-- Bucket name: checklist-staff-glasses-auditory
...
-- =====================================================
/*
INSERT INTO public.checklist_staff_glasses_auditory (
    date_string,
    monitor_name,
    monitor_signature,
    no_findings,
    ...
    '[
        ...
        },
        {
            ...
            "glassType": "Prescription glasses",
            "conditionIn": "not_comply",
            "conditionOut": "comply",
            "observationIn": "Glasses were damaged",
            "observationOut": ""
        }
    ]'::jsonb,
    'https://your-supabase-url.supabase.co/storage/v1/object/public/checklist-staff-glasses-auditory/2025-NOVEMBER-17-Staff-Glasses-Auditory-Control-01.pdf'
);
...
INSERT INTO public.checklist_staff_glasses_auditory (
    ...
    true,
    '[]'::jsonb,
    'https://your-supabase-url.supabase.co/storage/v1/object/public/checklist-staff-glasses-auditory/2025-NOVEMBER-17-Staff-Glasses-Auditory-Control-02.pdf'
);
*/
