...
export default function GestionSAPPage() {
  return (
      ...
      <div className="max-w-[1150px] mx-auto">
        <div className="mb-6">
          ...
          <h1 className="text-2xl font-semibold mb-2" style={{ color: '#111827' }}>
            Gestión de Solicitudes SAP
          </h1>
          <p className="text-sm" style={{ color: '#6B7280' }}>
            Asigna áreas responsables y envía notificaciones por email.
          </p>
        </div>

        <div className="bg-white rounded-lg p-6 border border-gray-200">
          <p className="text-gray-600">Gestión de solicitudes SAP - En desarrollo</p>
        </div>
      </div>
    </div>
  )
