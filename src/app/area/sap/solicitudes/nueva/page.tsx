      ...
      <div className="max-w-[1150px] mx-auto">
        <div className="mb-6">
          ...
          <p className="text-sm" style={{ color: '#6B7280' }}>
            Formulario para crear una nueva solicitud de acción preventiva o correctiva.
          </p>
        </div>

        <div className="bg-white rounded-lg p-6 border border-gray-200">
          <p className="text-gray-600">Formulario de nueva solicitud SAP - En desarrollo</p>
        </div>
      </div>
    </div>
  )
