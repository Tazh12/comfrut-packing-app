...
export default function HistorialSAPPage() {
  return (
      ...
      <div className="max-w-[1150px] mx-auto">
        <div className="mb-6">
          ...
          <p className="text-sm" style={{ color: '#6B7280' }}>
            Consulta el historial de solicitudes de acciones preventivas/correctivas.
          </p>
        </div>

        <div className="bg-white rounded-lg p-6 border border-gray-200">
          <p className="text-gray-600">Historial de solicitudes SAP - En desarrollo</p>
        </div>
      </div>
    </div>
  )
